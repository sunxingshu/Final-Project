...
class WaypointUpdater(object):
    def __init__(self):
        ...
        self.acceleration_limit_in_mps = 1
        self.deceleration_limit_max_in_mps = 5
        self.deceleration_limit_min_in_mps  = 1
    ...
    def get_closest_waypoint_index(self):
        ...
        waypoint_index = self.waypoint_tree.query([x,y],1)[1]
